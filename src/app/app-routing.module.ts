...
const routes: Routes = [
  ...
  {
    path: 'usuarios',
    loadChildren: () => import('src/app/usuarios/usuarios.module').then( m => m.UsuariosPageModule)
  },
  {
    path: 'cart-modal',
    loadChildren: () => import('src/app/cart-modal/cart-modal.module').then( m => m.CartModalPageModule)
  },
  {
    path: 'cart-modal',
